 ...
 *************************************************/
#define CS_LOW			PORTBbits.RB12 = 0;
#define CS_HIGH			PORTBbits.RB12 = 1;

#define SCK_PORT		PORTBbits.RB2
#define SCK_TRIS		TRISBbits.TRISB2 // .RB2
#define SDO_PORT		PORTBbits.RB14
#define SDO_TRIS		TRISBbits.TRISB14// .RB14
#define SDI_PORT		PORTBbits.RB13
#define SDI_TRIS		TRISBbits.TRISB13
#define CS_PORT			PORTBbits.RB12
#define CS_TRIS			TRISBbits.TRISB12
